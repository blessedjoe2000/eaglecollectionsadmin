...
function Nav({ showMobile }) {
  ...
  const activeLink = `flex gap-2 text-sharp-purple bg-white p-2 rounded-md`;
  ...
  return (
    <aside
      className={
        ...
        `  top-0 text-white p-4 fixed w-full bg-main-purple h-screen md:static md:w-auto transition-all`
      }
    >
